...
class BlurView: UIView {
  ...
  // serves as a transparency container for the blurringView as
  // it's not recommended by Apple to apply transparency directly to the UIVisualEffectsView
  ...
  func present() {
    ...
    UIView.animate(
      withDuration: blurPresentDuration,
      delay: blurPresentDelay,
      options: .curveLinear,
  ...
  func dismiss() {
    ...
    UIView.animate(
      withDuration: blurDismissDuration,
      delay: blurDismissDelay,
      options: .curveLinear,
      animations: { [weak self] in
    ...
    UIView.animate(
      withDuration: colorDismissDuration,
      delay: colorDismissDelay,
      options: .curveLinear,
      animations: { [weak self] in
