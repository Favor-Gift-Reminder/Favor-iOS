...
public struct GiftSingleResponseDTO: Decodable {
  ...
  public let giftPhotoList: [PhotoResponseDTO]
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.giftPhotoList = try container.decode([PhotoResponseDTO].self, forKey: .giftPhotoList)
