...
class OldFavorTextField: UITextField {
  ...
  private func addEditingChangedObserver() {
    self.addTarget(self, action: #selector(OldFavorTextField.editingChanged), for: .editingChanged)
  }
...
extension OldFavorTextField: BaseView {
  func setupStyles() {
...
private extension OldFavorTextField {
