...
final class NewGiftViewController: BaseViewController {
  ...
  private let giverButton = PlainFavorButton(with: .main(isRight: true), title: "친구 선택")
  private let receiverButton = PlainFavorButton(with: .main(isRight: true), title: "친구 선택")
  private lazy var friendLine = self.makeLine()
  private lazy var dateLabel = self.makeTitleLabel("날짜")
  private let dateButton = PlainFavorButton(with: .main(isRight: false), title: "날짜 선택")
